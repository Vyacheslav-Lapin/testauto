...
public class HelloService extends Service {
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://wsdl.xml.testauto.trainings.epam.com/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://wsdl.xml.testauto.trainings.epam.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsdl.xml.testauto.trainings.epam.com/", "HelloPort"), Hello.class, features);
    }
